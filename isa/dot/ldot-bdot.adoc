...
----
# Zvfqldot8f 8-bit integer dot product instructions
...
image::bdot-simple.svg[Static, pdfwidth=4in, title="Zvreddot operation, VLEN &#8804; 8*EEW"]
...
image::bdot-ci.svg[Static, pdfwidth=7in, title="Zvreddot operation, VLEN > 8*EEW"]
