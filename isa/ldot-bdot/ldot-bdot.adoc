...
= `Zvdota` and `Zvbdota` Families of Dot-Product Extensions, Version {dot-version}
...
== `Zvdota` Family of Dot-Product Extensions, Version {dot-version}
...
=== `Zvqwdota8i` 8-bit Integer Dot-Product Extension, Version {dot-version}
...
=== `Zvqwdota16i` 16-bit Integer Dot-Product Extension, Version {dot-version}
...
=== `Zvfwdota16bf` BF16 Dot-Product Extension, Version {dot-version}
...
=== `Zvfqwdota8f` OCP FP8 Dot-Product Extension, Version {dot-version}
...
https://github.com/riscv/riscv-isa-manual/blob/main/src/unpriv/rvbna.adoc#RVBNARTO[Rounding to Odd behavior in RVBNA].
...
instruction, rounding to odd as described in https://github.com/riscv/riscv-isa-manual/blob/main/src/unpriv/rvbna.adoc#RVBNARTO[Rounding to Odd behavior in RVBNA], in a precision no
...
rounding to odd as described in https://github.com/riscv/riscv-isa-manual/blob/main/src/unpriv/rvbna.adoc#RVBNARTO[Rounding to Odd behavior in RVBNA].
...
RVBNA specification as been moved to riscv-isa-manual: https://github.com/riscv/riscv-isa-manual/blob/main/src/unpriv/rvbna.adoc[RVBNA].
