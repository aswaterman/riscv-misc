...
== `Zvdota` Family of Long Dot-Product Extensions, Version {dot-version}
...
----
# Zvqwdota8i 8-bit integer long dot-product instructions
...
----
# Zvfwdota16bf BF16 long dot-product instruction
# altfmt=1
...
----
# Zvfqwdota8f OCP FP8 long dot-product instructions
