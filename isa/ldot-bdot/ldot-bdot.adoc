...
vqldots.vv vd, vs2, vs1, vm   # vd[0] += signed(vs2) dot vs1
----
...
vfqldot.alt.vv vd, vs2, vs1, vm   # vd[0] += E5M2(vs2) dot vs1
----
...
# signedness of vs1 supplied by altfmt (0 unsigned, 1 signed)
vqbdotu.vv vd, vs2, vs1, ci, vm   # vs2 unsigned
vqbdots.vv vd, vs2, vs1, ci, vm   # vs2 signed
----
...
# format of vs1 supplied by altfmt (0 E4M3, 1 E5M2)
vfqbdot.vv     vd, vs2, vs1, ci, vm   # vs2 E4M3
vfqbdot.alt.vv vd, vs2, vs1, ci, vm   # vs2 E5M2
----
